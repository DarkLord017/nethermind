...
public partial class EthRpcModuleTests
{
    ...
    public async Task Estimate_gas_returns_allowance_error_when_balance_insufficient_for_gas_price()
    {
        ...
        // and return "gas required exceeds allowance (N)" — not "insufficient MaxFeePerGas for sender balance".
        //
        // allowance = 0x100000000000 / 0xBA43B7400 = 1_099_511_627_776 / 50_000_000_000 = 21
        using Context ctx = await Context.CreateWithLondonEnabled();
